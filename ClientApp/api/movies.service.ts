...
export class MoviesService {
     ...
     */
    public apiMoviesAddMovieMovieIdPost(movieId: ObjectId, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiMoviesAddMovieMovieIdPost(movieId: ObjectId, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiMoviesAddMovieMovieIdPost(movieId: ObjectId, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiMoviesAddMovieMovieIdPost(movieId: ObjectId, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/Movies/AddMovie/${encodeURIComponent(String(movieId))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiMoviesMovieIdDelete(movieId: ObjectId, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiMoviesMovieIdDelete(movieId: ObjectId, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiMoviesMovieIdDelete(movieId: ObjectId, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiMoviesMovieIdDelete(movieId: ObjectId, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/api/Movies/${encodeURIComponent(String(movieId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,

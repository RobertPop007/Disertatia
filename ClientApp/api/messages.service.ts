...
export class MessagesService {
     ...
     */
    public apiMessagesGet(username?: string, container?: string, page_number?: number, page_size?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<MessageDto>>;
    public apiMessagesGet(username?: string, container?: string, page_number?: number, page_size?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<MessageDto>>>;
    public apiMessagesGet(username?: string, container?: string, page_number?: number, page_size?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<MessageDto>>>;
    public apiMessagesGet(username?: string, container?: string, page_number?: number, page_size?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
